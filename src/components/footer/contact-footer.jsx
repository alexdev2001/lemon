...
export default function FooterContact() {
    ...
    return (
        <footer className="relative footer bg-base-200 text-base-content p-8 h-[300px] font-custom  justify-between custom-footer-contact">
        ...
        <br/>
        <div className="text-center absolute bottom-2 left-1/2 transform -translate-x-1/2  custom-copyright">
